...
class FireEffect
{
  protected:
    ...
    uint    Sparking;           // Probability of a spark each attempt
  ...
  public:
    ...
    FireEffect(int size, int cooling = 20, uint sparking = 100, int sparks = 3, int sparkHeight = 4, bool breversed = true, bool bmirrored = true)
        : Size(size),
          Cooling(cooling),
          Sparks(sparks),
